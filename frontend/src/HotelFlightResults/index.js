...
class HotelFlightResults extends React.Component {
  render(){
...
HotelFlightResults.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(HotelFlightResults);
